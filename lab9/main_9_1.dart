...
//           children: [
//             CircleAvatar(
//               backgroundImage: AssetImage('assets/sub_assets/Manav.jpeg'),
//             ),
//             Text(
//               'NAME: ',
//               style: TextStyle(
...
// */
//   List<Quote> quotes = [
//     Quote(text: 'The truth is realy pure and never simple',author:  'Manav Shah'),
//     Quote(author: 'Manav Shah', text: 'I see humans but no humanity'),  Quote(text: 'The time is always right to do what is right',author:  'Manav Shah'),
//   ];
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
*/
  List<Quote> quotes = [
    Quote(text: 'The truth is that hardship pays', author: 'Manav Shah'),
    Quote(author: 'Manav Shah', text: 'I see humans with fame of humanity'),
    Quote(
        text: 'The time is not always right to do what is right',
        author: 'Manav Shah'),
  ];
