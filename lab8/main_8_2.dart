...
// */
//   List<Quote> quotes = [
//     Quote(text: 'The truth is realy pure and never simple',author:  'Manavshah'),
//     Quote(author: 'Manav', text: 'I see humans but no humanity'),  Quote(text: 'The time is always right to do what is right',author:  'shah'),
//   ];
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
*/
  List<Quote> quotes = [
    ...
    Quote(author: 'Manav', text: 'I see humans with fame of humanity'),
    Quote(
