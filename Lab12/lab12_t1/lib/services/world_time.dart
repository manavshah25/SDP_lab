...
//   String? url;
//   String? isDayTime;
//   // end point of static url...which will change every time  when location will change
...
//           Duration(minutes: int.parse(offsetMinutes),
//               hours: int.parse(offsetMinutes)));
